...
public class Cliente extends Registro implements Serializable {
	...
	public Cliente(Cpf cpf, String nome, double renda, int idade, int sexo) throws ExcecaoValorInvalido { // Construtor
		// para
		// inicializar
		// os
		// atributos
	...
	public double getRenda() { // Metodo para receber o valor do atributo
		return renda;
	}
	...
	public void setRenda(double renda) throws ExcecaoValorInvalido { // Metodo
																	// para
																	// atribuir
																	// valor ao
		if (renda > 0) {
