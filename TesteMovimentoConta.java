...
public class TesteMovimentoConta {
	...
	public static void main(String[] args) {
		...
		IdentificadorConta idc = new IdentificadorConta(99); // Inicializacao do
																...
																// tipo
																// identificadorConta
		IdentificadorConta idcc = new IdentificadorConta(54); // Inicializacao
																// do atributo
																// do tipo
																// identificadorConta
		ContaMilhagem cmO = new ContaMilhagem(idc, c); // Inicializacao do
														// atributo do tipo
														// ContaMilhagem
		ContaMilhagem cmD = new ContaMilhagem(idcc, c); // Inicializacao do
														// atributo do tipo
														// ContaMilhagem
		...
		MovimentoConta mc = new MovimentoConta(cmO, valor, tipo, cmD, nomeFonte, data); // Inicializacao
																						// do
																						// atributo
																						// do
																						// tipo
																						// MovimentoConta
		System.out.println(mc.toString() + "\n" + mc.getNomeExtrato()); // Imprimi
																		// na
																		// tela
																		// as
																		// informacoes
